...
from .exceptions import CancellationError, RegimeMapError
from .models import RegimeMapJobConfig
from .pipeline import RegimeMapPipeline


class RegimeMapWorker(QObject):
    ...
    def __init__(self, pipeline: RegimeMapPipeline, config: RegimeMapJobConfig) -> None:
        super().__init__()
    ...
    def run(self) -> None:
        try:
            ...
            self.status_changed.emit("Готово: режимная карта построена.")
